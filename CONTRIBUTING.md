# Contributing to AndroidUISpy
Welcome to [report Issues](https://github.com/qtacore/AndroidUISpy/issues) or [pull requests](https://github.com/qtacore/AndroidUISpy/pulls). It's recommended to read the following Contributing Guild first to make contributing earlier. 
...
## Pull Requests
We strongly welcome your pull request to make AndroidUISpy better. 
...
## License
By contributing to AndroidUISpy, you agree that your contributions will be licensed
under its [BSD LICENSE](https://github.com/qtacore/AndroidUISpy/blob/master/LICENSE)